...
import ge.space.ui.util.path.MaskPath
import ge.space.ui.util.path.MaskPathRoundedCorners
...
abstract class BaseView @JvmOverloads constructor(
     ...
     */
    private val clippingMaskPath: MaskPath = MaskPathRoundedCorners()

    /**
     * Path instance for base view shape
     * It gives us possibility to manipulate shape forms
     */
    private val bordersClippingMaskPath: MaskPath = MaskPathRoundedCorners()
     ...
     */
    protected var roundedCorners: Float = MaskPathRoundedCorners.DEFAULT_START_POINT
        set(value) {
            field = value
     ...
     */
    protected var topLeftCornerRadius: Float = MaskPathRoundedCorners.DEFAULT_START_POINT
        set(value) {
            field = value
     ...
     */
    protected var topRightCornerRadius: Float = MaskPathRoundedCorners.DEFAULT_START_POINT
        set(value) {
            field = value
     ...
     */
    protected var bottomRightCornerRadius: Float = MaskPathRoundedCorners.DEFAULT_START_POINT
        set(value) {
            field = value
     ...
     */
    protected var bottomLeftCornerRadius: Float = MaskPathRoundedCorners.DEFAULT_START_POINT
        set(value) {
            field = value
     ...
     */
    protected var shadowRadius: Float = MaskPathRoundedCorners.DEFAULT_START_POINT
        set(value) {
            field = value
     ...
     */
    protected var shadowOffsetX: Float = MaskPathRoundedCorners.DEFAULT_START_POINT
        set(value) {
            field = value
     ...
     */
    protected var shadowOffsetY: Float = MaskPathRoundedCorners.DEFAULT_START_POINT
        set(value) {
            field = value
     ...
     * attributes. Separate BaseView styleable attributes have higher priority han styles.
     * <p>
     *
    ...
    private fun getCornerRadius(cornerRadius: Float) =
        if (cornerRadius > MaskPathRoundedCorners.DEFAULT_START_POINT) cornerRadius
        else roundedCorners

    private fun getInsideCornerRadius(cornerRadius: Float): Float {
        val radius = if (cornerRadius > MaskPathRoundedCorners.DEFAULT_START_POINT) cornerRadius
        else roundedCorners
